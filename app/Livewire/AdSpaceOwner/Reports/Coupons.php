...
namespace App\Livewire\AdSpaceOwner\Reports;
...
class Coupons extends Component
{
    ...
    public function mount()
    {
        ...
        $this->columns = bbo_coupon_report_columns();
        $this->show_columns = ["type", "language", "title", "coupon_number", "original_amount", "paid_amount", "coupon_balance"];
    }
