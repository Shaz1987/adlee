...
class Task extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['user_id', 'sponsor_id', 'coupon_id', 'template_id', 'assign_to', 'is_commemoration', 'language', 'purpose', 'english_name', 'hebrew_name', 'status', 'document_id', 'signed_at', 'printed_at'];
