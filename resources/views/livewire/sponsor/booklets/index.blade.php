                        ...
                        <div class="text-center">
                            <p class="text-sm font-normal text-slate-600 mb-4">
                                ...
                                @elseif ($data['bookletRemaining'] == 0)
                                    {{ __("You are left 0 free booklet print for this month. In order to print and ship this booklet to you, you will be charged for $" . $data['bookletFee'] . '.') }}
                                @else
                                    {{ __('You are left ' . $data['bookletRemaining'] . " free booklet print for this month. In order to print and ship this booklet to you, you will be charged for $0") }}
                                @endif
                            </p>
