            ...
            <div class="card">
                    ...
                    <table class="invoice-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <p class="description mb-1">Advertising Payment</p>
                ...
                <div class="text-right">
                    ...
                    <div class="total-details">
                        <p>Sub Total : <span class="font-semibold">${{ number_format($transaction->amount, 2) }}</span>
                        </p>
                        @if ($type === 'sponsor')
                            <p>Transaction Fee ({{ $transaction->transaction_fee_percentage }}%) : <span
                                    class="font-semibold">${{ number_format($transaction->transaction_fee, 2) }}</span>
                            </p>
                        @endif
                        ...
                        @if (
                            ...
                            <p>Service Fee ({{ $transaction->service_fee_percentage }}%) : <span
                                    class="font-semibold">${{ number_format($transaction->service_fee, 2) }}</span></p>
                        @endif
                        <p class="final-total">Total: <span
                                class="font-semibold">${{ number_format($type === 'sponsor' ? $transaction->paid_amount : $transaction->receiver_amount, 2) }}</span>
                        </p>
                    </div>
                </div>
            </div>
