                    ...
                    <div class="p-4 sm:p-5">
                        <div class="text-center">
                            <p class="text-sm font-normal text-slate-600 mb-4">
                                ...
                                @else
                                    {{ __('You are left ' . $data['bookletRemaining'] . " free booklet print for this month. In order to print and ship this booklet to you that you are creating, you will be charged for $0") }}
                                @endif
                            </p>
